<template>
  <div class="flex justify-end text-slate-200 text-shadow text-xl">
    <form class="flex flex-col w-full" ref="form" @submit.prevent="sendEmail">
      ...
      <div class="flex justify-end">
        <button type="submit" value="Send"
          class="text-sm md:text-lg text-shadow border-2 rounded-lg p-3 w-1/3 hover:bg-sky-300 hover:bg-opacity-50 shadow-sm shadow-sky-600">Send</button>
      </div>
    </form>
  </div>
</template>
